...
/**
 * Acts as Scanner and allows easy file reading. Converts FileNotFoundExceptions into RuntimeExceptions
 * 
 * @author David
 * @version 1.0
 */
public class FileScanner  {
	...
	public FileScanner(String fileName) {
		try {
			...
			throw new RuntimeException("File not found - make sure you put it in the right place!");
		}
	}
